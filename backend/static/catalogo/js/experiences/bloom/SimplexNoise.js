 ...
 * @description Generador de ruido Simplex 2D ultra-rápido y ligero.
 * Utilizado para crear campos de fuerza de vector de turbulencia orgánica en las partículas.
 */

export class SimplexNoise {
    constructor() {
        // Tabla de permutaciones basada en algoritmo estándar de Ken Perlin
